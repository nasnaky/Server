...
CREATE TABLE `app_product` (
  ...
  `user_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `app_product_user_id_e5c98310_fk_app_user_id` (`user_id`),
  CONSTRAINT `app_product_user_id_e5c98310_fk_app_user_id` FOREIGN KEY (`user_id`) REFERENCES `app_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `django_content_type` VALUES (10,'account','emailaddress'),(11,'account','emailconfirmation'),(1,'admin','logentry'),(7,'app','product'),(6,'app','user'),(3,'auth','group'),(2,'auth','permission'),(8,'authtoken','token'),(9,'authtoken','tokenproxy'),(4,'contenttypes','contenttype'),(5,'sessions','session'),(12,'taggit','tag'),(13,'taggit','taggeditem');
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2023-05-01 02:32:20.722816'),(2,'taggit','0001_initial','2023-05-01 02:32:20.955816'),(3,'taggit','0002_auto_20150616_2121','2023-05-01 02:32:20.990816'),(4,'contenttypes','0002_remove_content_type_name','2023-05-01 02:32:21.094825'),(5,'taggit','0003_taggeditem_add_unique_index','2023-05-01 02:32:21.118855'),(6,'taggit','0004_alter_taggeditem_content_type_alter_taggeditem_tag','2023-05-01 02:32:21.129869'),(7,'taggit','0005_auto_20220424_2025','2023-05-01 02:32:21.135818'),(8,'auth','0001_initial','2023-05-01 02:32:21.452816'),(9,'auth','0002_alter_permission_name_max_length','2023-05-01 02:32:21.478843'),(10,'auth','0003_alter_user_email_max_length','2023-05-01 02:32:21.489852'),(11,'auth','0004_alter_user_username_opts','2023-05-01 02:32:21.498973'),(12,'auth','0005_alter_user_last_login_null','2023-05-01 02:32:21.507852'),(13,'auth','0006_require_contenttypes_0002','2023-05-01 02:32:21.512853'),(14,'auth','0007_alter_validators_add_error_messages','2023-05-01 02:32:21.522961'),(15,'auth','0008_alter_user_username_max_length','2023-05-01 02:32:21.531853'),(16,'auth','0009_alter_user_last_name_max_length','2023-05-01 02:32:21.540875'),(17,'auth','0010_alter_group_name_max_length','2023-05-01 02:32:21.564840'),(18,'auth','0011_update_proxy_permissions','2023-05-01 02:32:21.576818'),(19,'auth','0012_alter_user_first_name_max_length','2023-05-01 02:32:21.585817'),(20,'app','0001_initial','2023-05-01 02:32:22.117733'),(21,'account','0001_initial','2023-05-01 02:32:22.334687'),(22,'account','0002_email_max_length','2023-05-01 02:32:22.362692'),(23,'admin','0001_initial','2023-05-01 02:32:22.527653'),(24,'admin','0002_logentry_remove_auto_add','2023-05-01 02:32:22.541809'),(25,'admin','0003_logentry_add_action_flag_choices','2023-05-01 02:32:22.558829'),(26,'authtoken','0001_initial','2023-05-01 02:32:22.657654'),(27,'authtoken','0002_auto_20160226_1747','2023-05-01 02:32:22.726656'),(28,'authtoken','0003_tokenproxy','2023-05-01 02:32:22.733685'),(29,'sessions','0001_initial','2023-05-01 02:32:22.790652');
...
-- Dump completed on 2023-05-01 11:52:28
